...
CANONICAL_URL = "https://magic26.pages.dev/?v=20260701o"
...
def verify_production(expected_data_through: str | None = None) -> None:
    ...
    if "lightweight-charts.standalone.production.js" not in html or "app.js?v=20260701o" not in html or "styles.css?v=20260701k" not in html:
        raise RuntimeError("Production HTML missing TradingView-style chart loader")
    if "K 線圖" not in html and "app.js?v=20260701o" not in html:
    ...
    if "app.js?v=20260701o" not in html or "styles.css?v=20260701k" not in html:
