...
def verify_production(expected_data_through: str | None = None) -> None:
    ...
    if "lightweight-charts.standalone.production.js" not in html or "app.js?v=20260701y" not in html or "styles.css?v=20260701p" not in html:
    ...
    if "app.js?v=20260701y" not in html or "styles.css?v=20260701p" not in html:
